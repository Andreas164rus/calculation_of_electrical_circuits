...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_6.setPixmap(QtGui.QPixmap("../img/boosters/image.png"))
    ...
    def calculate(self):
        Ein = float(self.Ein.toPlainText())
        Ic = float(self.Ic.toPlainText())
        Ube = float(self.Ube.toPlainText())
        h21 = float(self.h21.toPlainText())
        Rk = Ein/(2*Ic)
        Ib = Ic/h21
        Uc = Ein - Ic * Rk
        Rb = (Uc - Ube)/Ib
        self.Rb.setPlainText(f"{Rb}")
        self.Rc.setPlainText(f"{Rk}")
        print(Ein)